...
Original file is located at
    https://colab.research.google.com/drive/1yU0AmrDeitrX-vHIOeUrIdVgaM1rF_cL
"""
...
print("\nFirst few rows of the dataset (by Mohammed  211P017):")
print(df.head())
...
print("Classification Report By Mohammed  211P017:")
print(classification_report(y_test, y_pred))

# Optional: Feature Importance Plot
# TabNet does not provide built-in feature importance, but you can inspect the learned features during training