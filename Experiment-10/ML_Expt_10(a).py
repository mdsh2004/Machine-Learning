...
Original file is located at
    https://colab.research.google.com/drive/1Ti0bd6q6kqYRzaWN83VXPY_hWdUbhuCK
"""
...
print("Classification Report By Muskan:")
print(classification_report(y_test, y_pred, target_names=iris.target_names))

# Step 9: Feature Importance Plot
xgb.plot_importance(xgb_model)
plt.title('Feature Importance of XGBoost Model By Muskan 211P017') # plt is now defined and can be used
plt.show()