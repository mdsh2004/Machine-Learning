...
Original file is located at
    https://colab.research.google.com/drive/1hyBBYwIM-BSk4_J5OMRXnsbzpZ0Dm2oy
"""
...
print("\nClassification Report By Mohammed  211P017:")
print(classification_report(y_test, y_pred, target_names=data.target_names))

# Optional: Feature Importance Plot
lgb.plot_importance(lgb_model, max_num_features=10, importance_type='split', title='Feature Importance By Mohammed  211P017')
plt.show()